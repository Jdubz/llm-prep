...
This guide covers the nuanced behavioral skills that separate candidates who clear the bar from candidates who receive strong hire signals: Amazon Leadership Principles in depth, staff-level behavioral expectations, handling curveball questions, reading the interviewer, body language and rapport, tailoring stories per company culture, and common traps that derail otherwise strong candidates. Read the fundamentals guide first.
...
| Principle | One-line summary | Story angle |
|-----------|-----------------|-------------|
| Customer Obsession | Start with the customer, work backwards | Customer impact, user research |
| Ownership | Think long-term, act beyond your scope | Fixing things "not your job" |
| Invent and Simplify | Innovate, simplify, look for external ideas | Novel solutions, removing complexity |
| Are Right, A Lot | Strong judgment, seek diverse perspectives | Good decisions backed by data |
| Learn and Be Curious | Never stop learning | Self-directed growth |
| Hire and Develop the Best | Raise the bar, mentor | Hiring decisions, mentorship |
| Insist on Highest Standards | Relentlessly high standards | Quality advocacy |
| Think Big | Bold vision, inspire results | Ambitious projects, big bets |
| Bias for Action | Move fast, calculated risk-taking | Deciding under uncertainty |
| Frugality | Do more with less | Efficiency, creative constraints |
| Earn Trust | Listen, be candid, respect others | Hard conversations, building trust |
| Dive Deep | No task too small, audit often | Debugging, root cause analysis |
| Have Backbone; Disagree and Commit | Challenge, then commit | Disagreeing with authority |
| Deliver Results | Focus on inputs, deliver quality on time | Shipping under pressure |
...
Amazon behavioral interviews are the most structured in the industry. Each interviewer is assigned 2-3 Leadership Principles (LPs) to evaluate. Prepare at least one story per LP.

| Principle | What they look for | Story angle |
|-----------|-------------------|-------------|
| Customer Obsession | Starting with the customer and working backwards | Customer impact stories |
| Ownership | Thinking long-term, acting on behalf of the whole company | Taking responsibility beyond your job description |
| Invent and Simplify | Innovating and finding ways to simplify | Novel solutions, process improvements |
| Are Right, A Lot | Good judgment, seeking diverse perspectives | Decision-making stories with good outcomes |
| Learn and Be Curious | Always learning, exploring new possibilities | Self-directed growth, exploring new domains |
| Hire and Develop the Best | Raising the bar, coaching others | Mentorship and hiring stories |
| Insist on the Highest Standards | Relentlessly high standards | Quality initiatives, refusing to cut corners |
| Think Big | Creating bold direction, inspiring results | Vision-setting, ambitious projects |
| Bias for Action | Speed matters, calculated risk-taking | Moving fast, making decisions under uncertainty |
| Frugality | Do more with less | Efficiency improvements, creative constraints |
| Earn Trust | Listening, speaking candidly, treating others respectfully | Building relationships, honest feedback |
| Dive Deep | Operating at all levels, auditing frequently | Debugging, data analysis, finding root causes |
| Have Backbone; Disagree and Commit | Challenging decisions respectfully, then committing | Productive disagreements |
| Deliver Results | Rising to the occasion, delivering with quality | Shipping under pressure |

### Google's Signals

Google evaluates "Googleyness and Leadership" which includes:
- Doing the right thing (ethics, user focus)
- Working well with others (collaboration, no ego)
- Being comfortable with ambiguity
- Pushing back respectfully
- Bringing something unique to the team

Angle your stories toward: collaboration, doing things at scale, data-driven decisions, user impact.

### Startup Culture Fit

Startups look for:
- Willingness to wear multiple hats
- Comfort with rapid change and limited process
- Ownership mentality (you see a problem, you fix it)
- Scrappiness (doing more with less)
- Passion for the product or domain

Angle your stories toward: resourcefulness, breadth, speed, direct business impact, building from scratch.
...
1. **Tailor, do not fabricate.** Adjust the angle of your stories for different companies, but never invent details.

2. **The behavioral bar at staff level is fundamentally different.** Your stories must demonstrate organizational influence, problem identification, and cross-team impact — not just excellent individual execution.

3. **Read the room.** Adjust your pace, depth, and framing based on interviewer signals. The ability to adapt in real time is itself a senior/staff signal.

4. **Authenticity beats polish on curveballs.** For unexpected questions, structured genuine thinking is worth more than smooth but hollow delivery.

5. **Amazon is its own category.** If you are interviewing there, treat LP preparation as seriously as technical preparation. Prepare 2 stories per principle minimum.
