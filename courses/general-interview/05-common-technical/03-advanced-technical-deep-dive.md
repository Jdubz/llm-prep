...
> For when the interviewer goes beyond the fundamentals. These topics separate "strong senior" from "staff-level" answers. Assumes both prior files have been read.
...
At the staff level, the expectation is not just "I know what a Bloom filter is" but "I know when a Bloom filter is the right tool, what its limits are, and how it compares to alternatives. I have used one in production, and here is what I learned."

The framing for every advanced topic:
1. The **problem** it solves and why the naive solution fails at scale
2. The **mechanism** at a level you could whiteboard
