...
This guide covers the written and presentation skills that define staff-level engineers: writing design documents and RFCs, technical writing for visibility, influencing technical decisions, giving effective code reviews, and presenting to leadership. These skills are directly evaluated in staff-level interviews and are the daily work of the role. Read the communication fundamentals guide first.
...
1. **Design docs are your primary tool for organizational influence.** A well-written RFC drives alignment, prevents mistakes, and creates institutional memory.

2. **Written communication compounds over time.** The post-mortems, blog posts, and decision records you write build your reputation and the organization's knowledge.

3. **Influence comes from persuasion, not authority.** Structure your technical arguments with data, acknowledge alternatives fairly, and gather input early.

4. **Leadership presentations require translation.** Your audience cares about outcomes, not implementation. Every technical point needs a business frame.

5. **Code reviews are teaching, not gatekeeping.** The tone, specificity, and focus of your feedback reflects your maturity as a senior engineer.
